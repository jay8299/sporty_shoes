...
<nav class="navbar navbar-expand-lg fixed-top navbar-light headerback"  style="background-color: #686463;">
  <a class="navbar-brand text-success logo" href="<%=request.getContextPath()%>/home" style="font-size: 31px; font-weight: bold; ">SportShoes</a>
